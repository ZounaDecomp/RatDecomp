...
private:
    ...
    Float m_CurFps;
    String_Z<256> m_TimeString;
    Float m_DisplayFpsUpdateTimer;
    String_Z<256> m_GpuString;
    Float m_GpuFps;
    String_Z<256> m_CpuString;
    Float m_CpuFps;
    String_Z<256> m_FpsString;
    Float m_Fps;
    String_Z<256> m_FragmentsString;
    String_Z<256> m_LargestBlockString;
    String_Z<256> m_FreeMemString;
    String_Z<256> m_MatrixUsageString;
    String_Z<256> m_LightC1String;
    String_Z<256> m_LightC2String;
    String_Z<256> m_PatchCDString;
    String_Z<256> m_GlobalDmaString;
    U32 m_GblDmaInUseNb;
    U32 m_GblDmaMaxInUseNb;
    U32 m_GblDmaTotalNb;
    String_Z<256> m_GifDmaString;
    U32 m_GifDmaInUseNb;
