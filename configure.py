...
config.libs = [
    ...
    DolphinLib(
        "os",
        [
            Object(NonMatching, "3rdParty/dolphin/os/__start.c"),
            Object(NonMatching, "3rdParty/dolphin/os/OS.c"),
            Object(NonMatching, "3rdParty/dolphin/os/OSAlarm.c"),
            Object(NonMatching, "3rdParty/dolphin/os/OSAlloc.c"),
            ...
            Object(NonMatching, "3rdParty/dolphin/os/OSMutex.c"),
    ...
    ),
    {
        ...
        "progress_category": "sdk",
        "objects": [
            Object(NonMatching, "3rdParty/dolphin/exi/EXIBios.c", extra_cflags=["-O3,p"]),
            Object(NonMatching, "3rdParty/dolphin/exi/EXIUart.c", extra_cflags=["-O4,p"]),
        ],
    },
    DolphinLib(
        "si",
        [
            Object(NonMatching, "3rdParty/dolphin/si/SIBios.c"),
            Object(NonMatching, "3rdParty/dolphin/si/SISamplingRate.c"),
        ],
    ),
    DolphinLib(
        "db",
    ...
    DolphinLib(
        "mtx",
        [
            Object(NonMatching, "3rdParty/dolphin/mtx/mtx.c", extra_cflags=["-char signed", "-O4,p"]),
            Object(NonMatching, "3rdParty/dolphin/mtx/mtx44.c", extra_cflags=["-char signed"]),
        ],
    ),
    DolphinLib(
        "dvd",
        [
            Object(NonMatching, "3rdParty/dolphin/dvd/dvdlow.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/dvd/dvdfs.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/dvd/dvd.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/dvd/dvdqueue.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/dvd/dvderror.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/dvd/dvdidutils.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/dvd/dvdFatal.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/dvd/fstload.c", extra_cflags=["-char signed"]),
        ],
    ),
    DolphinLib(
        "vi",
    ...
    DolphinLib(
        "pad",
        [
            Object(NonMatching, "3rdParty/dolphin/pad/Padclamp.c"),
            Object(NonMatching, "3rdParty/dolphin/pad/Pad.c"),
        ],
    ),
    DolphinLib(
        "ai",
        [
            Object(NonMatching, "3rdParty/dolphin/ai/ai.c"),
        ],
    ),
    DolphinLib(
        "locale",
    ...
    DolphinLib(
        "dsp",
        [
            Object(NonMatching, "3rdParty/dolphin/dsp/dsp.c"),
            Object(NonMatching, "3rdParty/dolphin/dsp/dsp_debug.c"),
            Object(NonMatching, "3rdParty/dolphin/dsp/dsp_task.c"),
        ],
    ),
    DolphinLib(
        "mix",
        [
            Object(NonMatching, "3rdParty/dolphin/mix/mix.c"),
        ],
    ),
    DolphinLib(
        "card",
        [
            Object(NonMatching, "3rdParty/dolphin/card/CARDBios.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDUnlock.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDRdwr.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDBlock.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDDir.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDCheck.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDMount.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDFormat.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDOpen.c", extra_cflags=["-char signed"]),
            Object(NonMatching, "3rdParty/dolphin/card/CARDCreate.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDRead.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDWrite.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDDelete.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDStat.c"),
            Object(NonMatching, "3rdParty/dolphin/card/CARDNet.c"),
        ],
    ),
    DolphinLib(
        "gx",
        [
            Object(NonMatching, "3rdParty/dolphin/gx/GXInit.c", extra_cflags=["-opt nopeephole"]),
            Object(NonMatching, "3rdParty/dolphin/gx/GXFifo.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXAttr.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXMisc.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXGeometry.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXFrameBuf.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXLight.c", extra_cflags=["-fp_contract off"]),
            Object(NonMatching, "3rdParty/dolphin/gx/GXTexture.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXBump.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXTev.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXPixel.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXDisplayList.c"),
            Object(NonMatching, "3rdParty/dolphin/gx/GXTransform.c", extra_cflags=["-fp_contract off"]),
            Object(NonMatching, "3rdParty/dolphin/gx/GXPerf.c"),
        ],
    ),
    DolphinLib(
        "gd",
    ...
    DolphinLib(
        "ar",
        [
            Object(NonMatching, "3rdParty/dolphin/ar/ar.c"),
            Object(NonMatching, "3rdParty/dolphin/ar/arq.c"),
        ],
    ),
    DolphinLib(
        "texPalette",
